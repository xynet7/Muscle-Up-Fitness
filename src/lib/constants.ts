...
export const MOCK_MEMBERSHIPS: Membership[] = [
  ...
  { id: 'm4', userName: 'Emily White', userEmail: 'emily.white@example.com', planId: 'premium', startDate: '2024-03-01', endDate: '2024-04-01', status: 'cancelled' },
  ...
  { id: 'm6', userName: 'Sarah Wilson', userEmail: 'sarah.w@example.com', planId: 'vip', startDate: '2024-05-25', endDate: '2024-06-25', status: 'active' },
];
